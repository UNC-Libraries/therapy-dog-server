...
module.exports = {
  ...
  FORMS_DIRECTORY: path.resolve('./test/fixtures/forms'),
  VOCABULARIES_DIRECTORY: path.resolve('./test/fixtures/vocabularies'),
  UPLOADS_DIRECTORY: path.resolve('./test/fixtures/uploads'),
